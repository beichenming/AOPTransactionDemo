...
@interface AOPLeftViewController ()
...
@implementation AOPLeftViewController
...
- (void)detailLeftBtnEvent:(id)sender {
...
//#endif
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Waring"
                                                    message:@"Left:This is Intact Version"
                                                   delegate:nil
...
- (UILabel *)titleLabel {
    if (_titleLabel == nil) {
        ...
        [_titleLabel setText:@"This is Left Page"];
...
- (UIButton *)detailBtn {
    if (_detailBtn == nil) {
        ...
        [_detailBtn addTarget:self action:@selector(detailLeftBtnEvent:) forControlEvents:UIControlEventTouchDown];
    }
    return _detailBtn;
}
