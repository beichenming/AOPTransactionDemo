...
@interface AOPRightViewController ()
...
@implementation AOPRightViewController
...
- (void)detailRightBtnEvent:(id)sender {
...
//#endif
   ...
   UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Waring"
                                                   message:@"Right:This is Intact Version"
                                                  delegate:nil
...
- (UILabel *)titleLabel {
    if (_titleLabel == nil) {
        ...
        [_titleLabel setText:@"This is Right Page"];
...
- (UIButton *)detailBtn {
    if (_detailBtn == nil) {
        ...
        [_detailBtn addTarget:self action:@selector(detailRightBtnEvent:) forControlEvents:UIControlEventTouchDown];
    }
    return _detailBtn;
}
